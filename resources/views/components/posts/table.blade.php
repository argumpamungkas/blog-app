@if (Session::has('success'))
    <div class="flex justify-center">
        <div id="toast-success"
            class="absolute top-38 flex items-center w-full max-w-xs p-4 mb-4 mx-auto text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800 dark:border-2 dark:border-green-900"
            role="alert">
            <div
...
<section class="p-3 sm:p-5 antialiased">
    ...
    <h2 class="text-xl font-bold text-gray-800 dark:text-white m-4">Post by: {{ Auth::user()->name }}</h2>
    <div class="max-w-screen-xl px-4">
        <!-- Start coding here -->
        <div class="bg-white dark:bg-gray-800 relative border dark:border-gray-700 sm:rounded-lg overflow-hidden">
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div
                                                ...
                                                <p class="mb-4 text-gray-500 dark:text-gray-300">Are you sure you
                                                    want
                                                    to delete item <b>{{ $post->title }}</b>?</p>
                                                <div class="flex justify-center items-center space-x-4">
                                                    ...
                                                    <form action="/dashboard/{{ $post->slug }}" method="POST">
                                                        @csrf
                                                        {{-- MESKIPUN METHOD FORM NYA POST, TAPI DENGAN FUNCTION @METHOD MAKA AKAN MENGIRIMKAN METHOD YANG DIBUAT --}}
                                                        @method('DELETE')
                                                        <button type="submit"
