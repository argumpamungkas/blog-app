    ...
    <form action="/dashboard/{{ $post->slug }}" method="POST" id="post-form">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title"
                class=" @error('title') bg-red-50 border-red-500 text-red</div>-900 placeholder-red-700 focus:ring-red-600 focus:border-red-600 @enderror
        ...
        <div class="mb-4">
            ...
            <select name="category_id" id="category"
                class=" @error('category_id') bg-red-50 border-red-500 text-red-900 placeholder-red-700 @enderror
